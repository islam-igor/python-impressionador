'''Exercícios
São exercícios bem parecidos com os que fizemos com listas. Mas na tupla, podemos não só trabalhar com índices, mas fazer o "unpacking" das tuplas,
 o que pode facilitar nossos códigos.

1. Análise de Vendas
Nesse exercício vamos fazer uma "análise simples" de atingimento de Meta.

Temos uma tupla com os vendedores e os valores de vendas e queremos identificar (printar) quais os vendedores que bateram a meta e qual foi o valor
 que eles venderam.'''
...
def tupla01():
    ...
    for nome, venda in vendas:
        if venda >= meta:
            print(f'o vendedor {nome} bateu a meta com  {venda} unidades')
'''
...
def tupla02():
    ...
    for produto, vendas2019, vendas2020 in vendas_produtos:
        if vendas2020 > vendas2019:
            print(f'o produto {produto} aumentou as vendas, em {((vendas2020/vendas2019) - 1):.2%}')
