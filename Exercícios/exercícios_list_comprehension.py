...
lista_2019 = [vendas_2019 for produto, vendas_2019, vendas_2020 in vendas_produtos]
...
produto_mais_2019 = max([(vendas_2019, produto) for produto, vendas_2019,vendas_2020 in vendas_produtos])
...
bateu_meta = [produto for i, produto in enumerate(produtos) if vendas_produtos[i] >= meta]

'''. Filtrar lista de clientes inadimplentes
O objetivo é identificar quem são os clientes inadimplentes e enviar essa lista de clientes para o
 setor de cobrança poder fazer a cobrança dos clientes.
...
cpf_inadplente = [(valor, cpf) for cpf, valor, dia in clientes_devedores if dia > 20]


'''lista = [item if condicao else outro_resultado for item in iterable]

Digamos que eu esteja analisando os vendedores de uma loja e queira criar uma lista para enviar 
para o RH com o bônus de cada vendedor.
...
bonus = [float(vendedores_dic[item] * 0.10) if vendedores_dic[item] > meta else 0 for item in vendedores_dic]

'''
. Tamanho do Pedido de Compras
Nesse exercício vamos avaliar o estoque de uma empresa. Vamos considerar que todos os produtos 
dessa empresa são comprados em lotes de 500 unidades.
...
lista = [1000 if qtd < 200 else 500 for codigo, qtd in estoque if qtd < 1000]
#maneira simplificada onde vai aparecer apenas os codigos maiores que 1000 , pedidos = 0 não sao incluidos

estoque = [('BSA2199',1396),('PPF5239',1251),('BSA1212',989),('PPF2154',449),('BEB3410',241),('PPF8999',527),('EMB9591',601),('BSA2006',314),('EMB3604',469),('EMB2070',733),('PPF9018',339),('PPF1468',906),('BSA5819',291),('PPF8666',850),('BEB2983',353),('BEB5877',456),('PPF5008',963),('PPF3877',185),('PPF7321',163),('BSA8833',644),('PPF4980',421),('PPF3063',757),('BSA2089',271),('BSA8398',180),('EMB4622',515),('EMB9814',563),('PPF3784',229),('PPF2398',270),('BEB3211',181),('PPF8655',459),('PPF1874',799),('PPF8789',126),('PPF6324',375),('EMB9290',883),('BSA5516',555),('BSA8451',243),('BSA8213',423)]


lista3 = [1000 if qtd < 200 else 500 if qtd < 1000 else 0 for codigo, qtd in estoque]
#aparece todos os valores dentro da lista, incluindo os valores de pedido = 0
...
produtos = ['coca', 'pepsi', 'guarana', 'skol', 'brahma', 'agua', 'del valle', 'dolly', 'red bull', 'cachaça', 'vinho tinto',
            'vodka', 'vinho branco', 'tequila', 'champagne', 'gin', 'guaracamp', 'matte', 'leite de castanha', 'leite', 'jurupinga',
            'sprite', 'fanta']

vendas = [1200, 300, 800, 1500, 1900, 2750, 400, 20, 23, 70, 90, 80, 1100, 999, 900, 880, 870, 50, 1111, 120, 300, 450, 800]

'''
x = dict(zip(produtos,vendas))       #apenas testando como encontrar o top 5
